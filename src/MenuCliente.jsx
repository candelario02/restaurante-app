...
const MenuCliente = () => {
  ...
  const enviarPedido = async (e) => {
    if (e) e.preventDefault(); // Previene recarga de página
  ...
  const renderBotonFlotante = () => (
    carrito.length > 0 && !verCarrito && !mostrarFormulario && (
      <button 
                ...
                <div key={p.id} className="producto-card">
                  ...
                  <div className="producto-info">
                    ...
                    <div className="precio-y-accion">
                      ...
                      <button className="btn-plus-item" onClick={() => agregarAlCarrito(p)}>
                        <Plus size={20} />
                      </button>
                    </div>
                  </div>
        ...
        <div className="overlay-msg">
          <div className="msg-box modal-carrito">
            ...
            <div className="modal-buttons">
              ...
              <button className="btn-yes" onClick={() => { setVerCarrito(false); setMostrarFormulario(true); }}>Pedir ahora</button>
            </div>
          </div>
        </div>
      )}
